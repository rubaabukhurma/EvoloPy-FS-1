# -*- coding: utf-8 -*-
"""
Created on Tue Aug  4 22:12:36 2020

@author: Ibrahim Aljarrah and Ruba Abu Khurma
"""
   ...
   # SalpPositions = numpy.zeros((N, dim))
    ...
    for i in range(0,N):
       # evaluate moths
        ...
        SalpFitness[i]=objf(SalpPositions[i,:],trainInput,trainOutput,dim) 
    ...
    while (Iteration<Max_iteration):
            ...
            if i<N/2:
                for j in range(0,dim):
                    ...
                    if c3<0.5:
                        ...
                        ss= transfer_functions_benchmark.s1(SalpPositions[j,i])
                        if (random.random()<ss): 
                          SalpPositions[j,i]=1;
                        else:
                          SalpPositions[j,i]=0;
        ...
        if (Iteration%1==0):
            print(['At iteration'+ str(Iteration+1)+' the best fitness on trainig is:'+ str(FoodFitness)+', the best number of features: '+str(featurecount)]);
